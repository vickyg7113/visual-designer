...
class M {
   ...
   */
  renderGuide(e) {
    const t = h.findElement(e.selector);
    if (!t) {
...
class w {
  ...
  enableEditor() {
    ...
    e || (e = localStorage.getItem("designerModeType") || null), console.log("[Visual Designer] Mode:", e), this.editorFrame.create((i) => this.handleEditorMessage(i), e);
    const t = e === "tag-page" || e === "tag-feature";
    t || this.editorMode.activate((i) => this.handleEditorMessage(i)), this.createExitEditorButton(), this.createRedBorderOverlay(), this.createStudioBadge(), localStorage.setItem("designerMode", "true"), e && localStorage.setItem("designerModeType", e), setTimeout(() => {
  ...
  handleEditorMessage(e) {
    switch (e.type) {
      ...
      case "TAG_FEATURE_CLICKED":
        this.editorMode.activate((t) => this.handleEditorMessage(t));
        break;
  ...
  /**
   * Show loading overlay while designer is initializing (Pendo-style)
   */
  showLoadingOverlay() {
