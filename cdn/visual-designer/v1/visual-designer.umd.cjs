...
<body>
  ...
  <\/script>
    ...
    `,document.head.appendChild(t);const i=document.createElement("div");i.textContent="Loading Visual Designer...",i.style.cssText=`
      ...
      font-size: 16px;
      font-weight: 500;
    `,this.loadingOverlay.appendChild(e),this.loadingOverlay.appendChild(i),document.body.appendChild(this.loadingOverlay)}hideLoadingOverlay(){this.loadingOverlay&&(this.loadingOverlay.remove(),this.loadingOverlay=null)}}let a=null,w=!1;function g(s){return a||(a=new b(s),a.init(),a)}function v(){return a}function x(s){!s||!Array.isArray(s)||s.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const t=e[0],i=e.slice(1);try{switch(t){case"initialize":{const n=i[0];g(n);break}case"identify":{const n=i[0];n&&console.log("[Visual Designer] identify (snippet) called with:",n);break}case"enableEditor":{(a??g()).enableEditor();break}case"disableEditor":{a&&a.disableEditor();break}case"loadGuides":{a&&a.loadGuides();break}case"getGuides":{if(a)return a.getGuides();break}default:console.warn("[Visual Designer] Unknown snippet method:",t)}}catch(n){console.error("[Visual Designer] Error processing queued call:",t,n)}})}if(typeof window<"u"){const s=window.visualDesigner;s&&Array.isArray(s._q)&&(w=!0,s.initialize=e=>{g(e)},s.identify=e=>{e&&console.log("[Visual Designer] identify (snippet) called with:",e)},s.enableEditor=()=>{(a??g()).enableEditor()},s.disableEditor=()=>{a&&a.disableEditor()},s.loadGuides=()=>{a&&a.loadGuides()},s.getGuides=()=>a?a.getGuides():void 0,s.getInstance=v,s.init=g,x(s._q));try{const e=new URL(window.location.href),t=e.searchParams.get("designer"),i=e.searchParams.get("mode");if(t==="true"){i&&(window.__visualDesignerMode=i,localStorage.setItem("designerModeType",i)),localStorage.setItem("designerMode","true"),e.searchParams.delete("designer"),e.searchParams.delete("mode");const n=e.toString();window.history.replaceState({},"",n),window.__visualDesignerWasLaunched=!0}}catch{}}if(typeof window<"u"&&!a&&!w){const s=()=>{a||g()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s()}typeof window<"u"&&(window.VisualDesigner={init:g,initialize:g,getInstance:v,DesignerSDK:b,_processQueue:x}),h.DesignerSDK=b,h._processQueue=x,h.getInstance=v,h.init=g,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})});
