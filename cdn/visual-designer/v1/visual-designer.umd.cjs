(function(c,u){typeof exports=="object"&&typeof module<"u"?u(exports):typeof define=="function"&&define.amd?define(["exports"],u):(c=typeof globalThis<"u"?globalThis:c||self,u(c.VisualDesigner={}))})(this,function(c){"use strict";class u{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const r=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-testid"}}const t=this.getSemanticDataAttributes(e);if(t.length>0){const r=t[0],s=e.getAttribute(r);return{selector:`[${r}="${this.escapeAttribute(s)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const n=this.generatePathSelector(e);return n?{selector:n,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch(t){return console.error("Invalid selector:",e,t),null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const t=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const n of t)e.hasAttribute(n)&&i.push(n);for(let n=0;n<e.attributes.length;n++){const r=e.attributes[n];r.name.startsWith("data-")&&!i.includes(r.name)&&i.push(r.name)}return i}static generateAriaSelector(e){var r;const t=e.getAttribute("role"),i=e.getAttribute("aria-label"),n=e.getAttribute("aria-labelledby");if(t){let s=`[role="${this.escapeAttribute(t)}"]`;if(i)return s+=`[aria-label="${this.escapeAttribute(i)}"]`,s;if(n){const a=document.getElementById(n);if(a&&((r=a.textContent)==null?void 0:r.trim()))return s}return s}return null}static generatePathSelector(e){const t=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let n=i.tagName.toLowerCase();if(i.id){n+=`#${this.escapeSelector(i.id)}`,t.unshift(n);break}if(i.className&&typeof i.className=="string"){const s=i.className.split(/\s+/).filter(a=>a&&!a.startsWith("designer-")).slice(0,2);s.length>0&&(n+="."+s.map(a=>this.escapeSelector(a)).join("."))}const r=i.parentElement;if(r){const s=i.tagName,g=Array.from(r.children).filter(l=>l.tagName===s);if(g.length>1){const l=g.indexOf(i)+1;n+=`:nth-of-type(${l})`}}if(t.unshift(n),i=r,t.length>=5)break}return t.length>0?t.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function k(o){var i,n;const e=o.getBoundingClientRect(),t={};for(let r=0;r<o.attributes.length;r++){const s=o.attributes[r];t[s.name]=s.value}return{tagName:o.tagName.toLowerCase(),id:o.id||void 0,className:((i=o.className)==null?void 0:i.toString())||void 0,textContent:((n=o.textContent)==null?void 0:n.trim().substring(0,50))||void 0,attributes:t,boundingRect:e}}function y(o){const e=window.getComputedStyle(o);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&o.getBoundingClientRect().height>0&&o.getBoundingClientRect().width>0}function m(){return window.location.pathname||"/"}function I(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function B(o){const e=o.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function G(o){B(o)||o.scrollIntoView({behavior:"smooth",block:"center"})}class L{constructor(){this.isActive=!1,this.highlightOverlay=null,this.selectedElement=null,this.messageCallback=null,this.handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const t=e.target;if(!(!t||t===this.highlightOverlay)){if(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn")){this.hideHighlight();return}if(!y(t)){this.hideHighlight();return}this.highlightElement(t)}},this.handleClick=e=>{if(!this.isActive)return;const t=e.target;t&&(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn")||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),y(t)&&this.selectElement(t)))},this.handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback&&this.messageCallback({type:"CANCEL"}),this.selectedElement=null,this.hideHighlight())}}activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.selectedElement=null,this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
    ...
    `,document.head.appendChild(e)}removeEditorStyles(){const e=document.getElementById("designer-editor-styles");e&&e.remove()}}class M{constructor(){this.renderedGuides=new Map,this.container=null}renderGuides(e){this.clear();const t=m();e.filter(n=>n.page===t&&n.status==="active").forEach(n=>{this.renderGuide(n)})}renderGuide(e){const t=u.findElement(e.selector);if(!t){console.warn(`Guide "${e.id}" target not found: ${e.selector}`);return}G(t);const i=this.createTooltip(e,t);this.renderedGuides.set(e.id,i),this.container||this.createContainer(),this.container&&this.container.appendChild(i),this.positionTooltip(i,t,e.placement)}dismissGuide(e){const t=this.renderedGuides.get(e);t&&(t.remove(),this.renderedGuides.delete(e))}clear(){this.renderedGuides.forEach(e=>e.remove()),this.renderedGuides.clear()}createTooltip(e,t){const i=document.createElement("div");i.className="designer-guide-tooltip",i.dataset.guideId=e.id,i.style.cssText=`
      position: absolute;
      background: white;
      border: 2px solid #3b82f6;
      border-radius: 8px;
    ...
    `,r.onmouseover=()=>{r.style.background="#2563eb"},r.onmouseout=()=>{r.style.background="#3b82f6"},r.onclick=()=>{this.dismissGuide(e.id)},i.appendChild(r);const s=document.createElement("div");return s.className="designer-guide-arrow",s.style.cssText=`
      ...
      height: 0;
      border-style: solid;
    `,i.appendChild(s),i}positionTooltip(e,t,i){const n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),s=window.pageXOffset||document.documentElement.scrollLeft,a=window.pageYOffset||document.documentElement.scrollTop,g=e.querySelector(".designer-guide-arrow");let l=0,h=0,p="";switch(i){case"top":l=n.top+a-r.height-12,h=n.left+s+n.width/2-r.width/2,p=`
          bottom: -8px;
          left: 50%;
        ...
        `;break}const S=window.innerWidth,C=window.innerHeight;h<s?h=s+10:h+r.width>s+S&&(h=s+S-r.width-10),l<a?l=a+10:l+r.height>a+C&&(l=a+C-r.height-10),e.style.top=`${l}px`,e.style.left=`${h}px`,g&&(g.style.cssText+=p)}createContainer(){this.container=document.createElement("div"),this.container.id="designer-guides-container",this.container.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
...
<body>
  ...
  <\/script>
      ...
      pointer-events: auto;
    `,this.exitEditorButton.onmouseenter=()=>{this.exitEditorButton&&(this.exitEditorButton.style.background="#3b82f6",this.exitEditorButton.style.color="#ffffff",this.exitEditorButton.style.transform="translateY(-2px)",this.exitEditorButton.style.boxShadow="0 6px 16px rgba(0, 0, 0, 0.2)")},this.exitEditorButton.onmouseleave=()=>{this.exitEditorButton&&(this.exitEditorButton.style.background="#ffffff",this.exitEditorButton.style.color="#3b82f6",this.exitEditorButton.style.transform="translateY(0)",this.exitEditorButton.style.boxShadow="0 4px 12px rgba(0, 0, 0, 0.15)")},this.exitEditorButton.onclick=()=>{this.disableEditor()},document.body.appendChild(this.exitEditorButton)}}removeExitEditorButton(){this.exitEditorButton&&(this.exitEditorButton.remove(),this.exitEditorButton=null)}}let d=null,E=!1;function f(o){return d||(d=new b(o),d.init(),d)}function v(){return d}function w(o){!o||!Array.isArray(o)||o.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const t=e[0],i=e.slice(1);try{switch(t){case"initialize":{const n=i[0];f(n);break}case"identify":{const n=i[0];n&&console.log("[Visual Designer] identify (snippet) called with:",n);break}case"enableEditor":{(d??f()).enableEditor();break}case"disableEditor":{d&&d.disableEditor();break}case"loadGuides":{d&&d.loadGuides();break}case"getGuides":{if(d)return d.getGuides();break}default:console.warn("[Visual Designer] Unknown snippet method:",t)}}catch(n){console.error("[Visual Designer] Error processing queued call:",t,n)}})}if(typeof window<"u"){const o=window.visualDesigner;o&&Array.isArray(o._q)&&(E=!0);try{const e=new URL(window.location.href);if(e.searchParams.get("designer")==="true"){e.searchParams.delete("designer");const i=e.toString();window.history.replaceState({},"",i),window.__visualDesignerWasLaunched=!0}}catch{}}if(typeof window<"u"&&!d){const o=window.__visualDesignerWasLaunched===!0;if(!E||o){const e=()=>{!d&&(!E||o)&&f()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}}typeof window<"u"&&(window.VisualDesigner={init:f,getInstance:v,DesignerSDK:b,_processQueue:w}),c.DesignerSDK=b,c._processQueue=w,c.getInstance=v,c.init=f,Object.defineProperty(c,Symbol.toStringTag,{value:"Module"})});
