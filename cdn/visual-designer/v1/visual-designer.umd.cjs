(function(u,h){typeof exports=="object"&&typeof module<"u"?h(exports):typeof define=="function"&&define.amd?define(["exports"],h):(u=typeof globalThis<"u"?globalThis:u||self,h(u.VisualDesigner={}))})(this,function(u){"use strict";class h{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const r=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-testid"}}const t=this.getSemanticDataAttributes(e);if(t.length>0){const r=t[0],o=e.getAttribute(r);return{selector:`[${r}="${this.escapeAttribute(o)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const n=this.generatePathSelector(e);return n?{selector:n,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch(t){return console.error("Invalid selector:",e,t),null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const t=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const n of t)e.hasAttribute(n)&&i.push(n);for(let n=0;n<e.attributes.length;n++){const r=e.attributes[n];r.name.startsWith("data-")&&!i.includes(r.name)&&i.push(r.name)}return i}static generateAriaSelector(e){var r;const t=e.getAttribute("role"),i=e.getAttribute("aria-label"),n=e.getAttribute("aria-labelledby");if(t){let o=`[role="${this.escapeAttribute(t)}"]`;if(i)return o+=`[aria-label="${this.escapeAttribute(i)}"]`,o;if(n){const d=document.getElementById(n);if(d&&((r=d.textContent)==null?void 0:r.trim()))return o}return o}return null}static generatePathSelector(e){const t=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let n=i.tagName.toLowerCase();if(i.id){n+=`#${this.escapeSelector(i.id)}`,t.unshift(n);break}if(i.className&&typeof i.className=="string"){const o=i.className.split(/\s+/).filter(d=>d&&!d.startsWith("designer-")).slice(0,2);o.length>0&&(n+="."+o.map(d=>this.escapeSelector(d)).join("."))}const r=i.parentElement;if(r){const o=i.tagName,g=Array.from(r.children).filter(l=>l.tagName===o);if(g.length>1){const l=g.indexOf(i)+1;n+=`:nth-of-type(${l})`}}if(t.unshift(n),i=r,t.length>=5)break}return t.length>0?t.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function B(a){var i,n;const e=a.getBoundingClientRect(),t={};for(let r=0;r<a.attributes.length;r++){const o=a.attributes[r];t[o.name]=o.value}return{tagName:a.tagName.toLowerCase(),id:a.id||void 0,className:((i=a.className)==null?void 0:i.toString())||void 0,textContent:((n=a.textContent)==null?void 0:n.trim().substring(0,50))||void 0,attributes:t,boundingRect:e}}function y(a){const e=window.getComputedStyle(a);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&a.getBoundingClientRect().height>0&&a.getBoundingClientRect().width>0}function f(){return window.location.pathname||"/"}function C(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function I(a){const e=a.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function T(a){I(a)||a.scrollIntoView({behavior:"smooth",block:"center"})}class L{constructor(){this.isActive=!1,this.highlightOverlay=null,this.selectedElement=null,this.messageCallback=null,this.handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const t=e.target;if(!(!t||t===this.highlightOverlay)){if(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")){this.hideHighlight();return}if(!y(t)){this.hideHighlight();return}this.highlightElement(t)}},this.handleClick=e=>{if(!this.isActive)return;const t=e.target;t&&(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),y(t)&&this.selectElement(t)))},this.handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback&&this.messageCallback({type:"CANCEL"}),this.selectedElement=null,this.hideHighlight())}}activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.selectedElement=null,this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
      position: absolute;
      pointer-events: none;
    ...
    `,document.head.appendChild(e)}removeEditorStyles(){const e=document.getElementById("designer-editor-styles");e&&e.remove()}}class M{constructor(){this.renderedGuides=new Map,this.container=null}renderGuides(e){this.clear();const t=f();e.filter(n=>n.page===t&&n.status==="active").forEach(n=>{this.renderGuide(n)})}renderGuide(e){const t=h.findElement(e.selector);if(!t){console.warn(`Guide "${e.id}" target not found: ${e.selector}`);return}T(t);const i=this.createTooltip(e,t);this.renderedGuides.set(e.id,i),this.container||this.createContainer(),this.container&&this.container.appendChild(i),this.positionTooltip(i,t,e.placement)}dismissGuide(e){const t=this.renderedGuides.get(e);t&&(t.remove(),this.renderedGuides.delete(e))}clear(){this.renderedGuides.forEach(e=>e.remove()),this.renderedGuides.clear()}createTooltip(e,t){const i=document.createElement("div");i.className="designer-guide-tooltip",i.dataset.guideId=e.id,i.style.cssText=`
      position: absolute;
      background: white;
      border: 2px solid #3b82f6;
      border-radius: 8px;
      ...
      line-height: 1.5;
      color: #111827;
    `;const n=document.createElement("div");n.style.cssText="margin-bottom: 8px;",n.textContent=e.content,i.appendChild(n);const r=document.createElement("button");r.textContent="Got it",r.style.cssText=`
      background: #3b82f6;
      color: white;
      border: none;
      border-radius: 4px;
    ...
    `,r.onmouseover=()=>{r.style.background="#2563eb"},r.onmouseout=()=>{r.style.background="#3b82f6"},r.onclick=()=>{this.dismissGuide(e.id)},i.appendChild(r);const o=document.createElement("div");return o.className="designer-guide-arrow",o.style.cssText=`
      position: absolute;
      width: 0;
      height: 0;
      border-style: solid;
    `,i.appendChild(o),i}positionTooltip(e,t,i){const n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),o=window.pageXOffset||document.documentElement.scrollLeft,d=window.pageYOffset||document.documentElement.scrollTop,g=e.querySelector(".designer-guide-arrow");let l=0,c=0,m="";switch(i){case"top":l=n.top+d-r.height-12,c=n.left+o+n.width/2-r.width/2,m=`
          bottom: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 8px 8px 0 8px;
          border-color: #3b82f6 transparent transparent transparent;
        `;break;case"bottom":l=n.bottom+d+12,c=n.left+o+n.width/2-r.width/2,m=`
          top: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 0 8px 8px 8px;
          border-color: transparent transparent #3b82f6 transparent;
        `;break;case"left":l=n.top+d+n.height/2-r.height/2,c=n.left+o-r.width-12,m=`
          right: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 0 8px 8px;
          border-color: transparent transparent transparent #3b82f6;
        `;break;case"right":l=n.top+d+n.height/2-r.height/2,c=n.right+o+12,m=`
          left: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 8px 8px 0;
          border-color: transparent #3b82f6 transparent transparent;
        `;break}const k=window.innerWidth,S=window.innerHeight;c<o?c=o+10:c+r.width>o+k&&(c=o+k-r.width-10),l<d?l=d+10:l+r.height>d+S&&(l=d+S-r.height-10),e.style.top=`${l}px`,e.style.left=`${c}px`,g&&(g.style.cssText+=m)}createContainer(){this.container=document.createElement("div"),this.container.id="designer-guides-container",this.container.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
      ...
      pointer-events: none;
      z-index: 999996;
    `,document.body.appendChild(this.container)}updatePositions(e){this.renderedGuides.forEach((t,i)=>{const n=e.find(o=>o.id===i);if(!n)return;const r=h.findElement(n.selector);r&&this.positionTooltip(t,r,n.placement)})}}class D{constructor(){this.iframe=null,this.dragHandle=null,this.messageCallback=null,this.isReady=!1,this.mode=null,this.isDragging=!1,this.dragStartX=0,this.dragStartY=0,this.currentX=0,this.currentY=0,this.dragThreshold=3,this.mouseDownX=0,this.mouseDownY=0,this.isMouseDown=!1,this.handleMouseDown=e=>{if(!this.iframe||!this.dragHandle)return;this.mouseDownX=e.clientX,this.mouseDownY=e.clientY,this.isMouseDown=!0,this.isDragging=!1;const t=this.iframe.getBoundingClientRect();this.dragStartX=e.clientX-t.left,this.dragStartY=e.clientY-t.top,this.currentX=t.left,this.currentY=t.top,e.preventDefault(),e.stopPropagation()},this.handleMouseMove=e=>{if(!this.isMouseDown||!this.iframe||!this.dragHandle)return;if(!this.isDragging){const l=Math.abs(e.clientX-this.mouseDownX),c=Math.abs(e.clientY-this.mouseDownY);if(Math.sqrt(l*l+c*c)>this.dragThreshold)this.isDragging=!0,document.body.style.cursor="move",document.body.style.userSelect="none",document.documentElement.style.userSelect="none";else return}e.preventDefault(),e.stopPropagation();const t=e.clientX-this.dragStartX,i=e.clientY-this.dragStartY,n=window.innerWidth,r=window.innerHeight,o=this.iframe.offsetWidth;this.iframe.offsetHeight;const d=Math.max(-o+50,Math.min(t,n-50)),g=Math.max(0,Math.min(i,r-100));this.currentX=d,this.currentY=g,this.iframe.style.left=`${d}px`,this.iframe.style.top=`${g}px`,this.iframe.style.right="auto",this.iframe.style.bottom="auto",this.dragHandle.style.left=`${d}px`,this.dragHandle.style.top=`${g}px`},this.handleMouseUp=e=>{this.isMouseDown&&(this.isDragging=!1,this.isMouseDown=!1,document.body.style.cursor="",document.body.style.userSelect="",document.documentElement.style.userSelect="",e.preventDefault(),e.stopPropagation())},this.handleMessage=e=>{const t=e.data;!t||!t.type||(this.messageCallback&&this.messageCallback(t),(t.type==="CANCEL"||t.type==="GUIDE_SAVED"||t.type==="SAVE_TAG_FEATURE")&&this.hide())}}create(e,t){if(console.log("[Visual Designer] EditorFrame.create() called with mode:",t),this.iframe){console.warn("[Visual Designer] EditorFrame already created, skipping");return}this.mode=t||null,this.messageCallback=e,console.log("[Visual Designer] Creating editor iframe with mode:",this.mode),this.iframe=document.createElement("iframe"),this.iframe.id="designer-editor-frame",this.iframe.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 600px;
...
<body>
  ...
  <\/script>
    ...
    `,e.onmouseenter=()=>{e.style.background="#e2e8f0",e.style.borderColor="#cbd5e1"},e.onmouseleave=()=>{e.style.background="#f1f5f9",e.style.borderColor="#e2e8f0"};const t=document.createElement("div");t.style.cssText=`
      display: grid;
    ...
    `,document.head.appendChild(t);const i=document.createElement("div");i.textContent="Loading Visual Designer...",i.style.cssText=`
      ...
      font-weight: 500;
      font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, sans-serif;
    `,this.loadingOverlay.appendChild(e),this.loadingOverlay.appendChild(i),document.body.appendChild(this.loadingOverlay)}hideLoadingOverlay(){this.loadingOverlay&&(this.loadingOverlay.remove(),this.loadingOverlay=null)}}let s=null,w=!1;function p(a){return s||(s=new b(a),s.init(),s)}function v(){return s}function x(a){!a||!Array.isArray(a)||a.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const t=e[0],i=e.slice(1);try{switch(t){case"initialize":{const n=i[0];p(n);break}case"identify":{const n=i[0];n&&console.log("[Visual Designer] identify (snippet) called with:",n);break}case"enableEditor":{(s??p()).enableEditor();break}case"disableEditor":{s&&s.disableEditor();break}case"loadGuides":{s&&s.loadGuides();break}case"getGuides":{if(s)return s.getGuides();break}default:console.warn("[Visual Designer] Unknown snippet method:",t)}}catch(n){console.error("[Visual Designer] Error processing queued call:",t,n)}})}if(typeof window<"u"){const a=window.visualDesigner;a&&Array.isArray(a._q)&&(w=!0,a.initialize=e=>{p(e)},a.identify=e=>{e&&console.log("[Visual Designer] identify (snippet) called with:",e)},a.enableEditor=()=>{(s??p()).enableEditor()},a.disableEditor=()=>{s&&s.disableEditor()},a.loadGuides=()=>{s&&s.loadGuides()},a.getGuides=()=>s?s.getGuides():void 0,a.getInstance=v,a.init=p,x(a._q));try{const e=new URL(window.location.href),t=e.searchParams.get("designer"),i=e.searchParams.get("mode");if(t==="true"){i&&(window.__visualDesignerMode=i,localStorage.setItem("designerModeType",i)),localStorage.setItem("designerMode","true"),e.searchParams.delete("designer"),e.searchParams.delete("mode");const n=e.toString();window.history.replaceState({},"",n),window.__visualDesignerWasLaunched=!0}}catch{}}if(typeof window<"u"&&!s&&!w){const a=()=>{s||p()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a()}typeof window<"u"&&(window.VisualDesigner={init:p,initialize:p,getInstance:v,DesignerSDK:b,_processQueue:x}),u.DesignerSDK=b,u._processQueue=x,u.getInstance=v,u.init=p,Object.defineProperty(u,Symbol.toStringTag,{value:"Module"})});
