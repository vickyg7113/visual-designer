(function(h,g){typeof exports=="object"&&typeof module<"u"?g(exports):typeof define=="function"&&define.amd?define(["exports"],g):(h=typeof globalThis<"u"?globalThis:h||self,g(h.VisualDesigner={}))})(this,function(h){"use strict";class g{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const o=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(o)}"]`,confidence:"high",method:"data-testid"}}const t=this.getSemanticDataAttributes(e);if(t.length>0){const o=t[0],r=e.getAttribute(o);return{selector:`[${o}="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const n=this.generatePathSelector(e);return n?{selector:n,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch(t){return console.error("Invalid selector:",e,t),null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const t=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const n of t)e.hasAttribute(n)&&i.push(n);for(let n=0;n<e.attributes.length;n++){const o=e.attributes[n];o.name.startsWith("data-")&&!i.includes(o.name)&&i.push(o.name)}return i}static generateAriaSelector(e){var o;const t=e.getAttribute("role"),i=e.getAttribute("aria-label"),n=e.getAttribute("aria-labelledby");if(t){let r=`[role="${this.escapeAttribute(t)}"]`;if(i)return r+=`[aria-label="${this.escapeAttribute(i)}"]`,r;if(n){const a=document.getElementById(n);if(a&&((o=a.textContent)==null?void 0:o.trim()))return r}return r}return null}static generatePathSelector(e){const t=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let n=i.tagName.toLowerCase();if(i.id){n+=`#${this.escapeSelector(i.id)}`,t.unshift(n);break}if(i.className&&typeof i.className=="string"){const r=i.className.split(/\s+/).filter(a=>a&&!a.startsWith("designer-")).slice(0,2);r.length>0&&(n+="."+r.map(a=>this.escapeSelector(a)).join("."))}const o=i.parentElement;if(o){const r=i.tagName,u=Array.from(o.children).filter(d=>d.tagName===r);if(u.length>1){const d=u.indexOf(i)+1;n+=`:nth-of-type(${d})`}}if(t.unshift(n),i=o,t.length>=5)break}return t.length>0?t.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function C(s){var i,n;const e=s.getBoundingClientRect(),t={};for(let o=0;o<s.attributes.length;o++){const r=s.attributes[o];t[r.name]=r.value}return{tagName:s.tagName.toLowerCase(),id:s.id||void 0,className:((i=s.className)==null?void 0:i.toString())||void 0,textContent:((n=s.textContent)==null?void 0:n.trim().substring(0,50))||void 0,attributes:t,boundingRect:e}}function x(s){const e=window.getComputedStyle(s);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&s.getBoundingClientRect().height>0&&s.getBoundingClientRect().width>0}function m(){return window.location.pathname||"/"}function M(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function B(s){const e=s.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function D(s){B(s)||s.scrollIntoView({behavior:"smooth",block:"center"})}class L{constructor(){this.isActive=!1,this.highlightOverlay=null,this.selectedElement=null,this.messageCallback=null,this.handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const t=e.target;if(!(!t||t===this.highlightOverlay)){if(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")){this.hideHighlight();return}if(!x(t)){this.hideHighlight();return}this.highlightElement(t)}},this.handleClick=e=>{if(!this.isActive)return;const t=e.target;t&&(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),x(t)&&this.selectElement(t)))},this.handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback&&this.messageCallback({type:"CANCEL"}),this.selectedElement=null,this.hideHighlight())}}activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.selectedElement=null,this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
    ...
    `,document.head.appendChild(e)}removeEditorStyles(){const e=document.getElementById("designer-editor-styles");e&&e.remove()}}class I{constructor(){this.renderedGuides=new Map,this.container=null}renderGuides(e){this.clear();const t=m();e.filter(n=>n.page===t&&n.status==="active").forEach(n=>{this.renderGuide(n)})}renderGuide(e){const t=g.findElement(e.selector);if(!t){console.warn(`Guide "${e.id}" target not found: ${e.selector}`);return}D(t);const i=this.createTooltip(e,t);this.renderedGuides.set(e.id,i),this.container||this.createContainer(),this.container&&this.container.appendChild(i),this.positionTooltip(i,t,e.placement)}dismissGuide(e){const t=this.renderedGuides.get(e);t&&(t.remove(),this.renderedGuides.delete(e))}clear(){this.renderedGuides.forEach(e=>e.remove()),this.renderedGuides.clear()}createTooltip(e,t){const i=document.createElement("div");i.className="designer-guide-tooltip",i.dataset.guideId=e.id,i.style.cssText=`
      position: absolute;
      background: white;
      border: 2px solid #3b82f6;
      border-radius: 8px;
    ...
    `,o.onmouseover=()=>{o.style.background="#2563eb"},o.onmouseout=()=>{o.style.background="#3b82f6"},o.onclick=()=>{this.dismissGuide(e.id)},i.appendChild(o);const r=document.createElement("div");return r.className="designer-guide-arrow",r.style.cssText=`
      ...
      height: 0;
      border-style: solid;
    `,i.appendChild(r),i}positionTooltip(e,t,i){const n=t.getBoundingClientRect(),o=e.getBoundingClientRect(),r=window.pageXOffset||document.documentElement.scrollLeft,a=window.pageYOffset||document.documentElement.scrollTop,u=e.querySelector(".designer-guide-arrow");let d=0,c=0,p="";switch(i){case"top":d=n.top+a-o.height-12,c=n.left+r+n.width/2-o.width/2,p=`
          bottom: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 8px 8px 0 8px;
          border-color: #3b82f6 transparent transparent transparent;
        `;break;case"bottom":d=n.bottom+a+12,c=n.left+r+n.width/2-o.width/2,p=`
          top: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 0 8px 8px 8px;
          border-color: transparent transparent #3b82f6 transparent;
        `;break;case"left":d=n.top+a+n.height/2-o.height/2,c=n.left+r-o.width-12,p=`
          right: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 0 8px 8px;
          border-color: transparent transparent transparent #3b82f6;
        `;break;case"right":d=n.top+a+n.height/2-o.height/2,c=n.right+r+12,p=`
          left: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 8px 8px 0;
          border-color: transparent #3b82f6 transparent transparent;
        `;break}const S=window.innerWidth,k=window.innerHeight;c<r?c=r+10:c+o.width>r+S&&(c=r+S-o.width-10),d<a?d=a+10:d+o.height>a+k&&(d=a+k-o.height-10),e.style.top=`${d}px`,e.style.left=`${c}px`,u&&(u.style.cssText+=p)}createContainer(){this.container=document.createElement("div"),this.container.id="designer-guides-container",this.container.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
...
<body>
  ...
  <\/script>
    ...
    `,document.head.appendChild(t);const i=document.createElement("div");i.textContent="Loading Visual Designer...",i.style.cssText=`
      ...
      font-size: 16px;
      font-weight: 500;
    `,this.loadingOverlay.appendChild(e),this.loadingOverlay.appendChild(i),document.body.appendChild(this.loadingOverlay)}hideLoadingOverlay(){this.loadingOverlay&&(this.loadingOverlay.remove(),this.loadingOverlay=null)}}let l=null,v=!1;function f(s){return l||(l=new b(s),l.init(),l)}function E(){return l}function w(s){!s||!Array.isArray(s)||s.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const t=e[0],i=e.slice(1);try{switch(t){case"initialize":{const n=i[0];f(n);break}case"identify":{const n=i[0];n&&console.log("[Visual Designer] identify (snippet) called with:",n);break}case"enableEditor":{(l??f()).enableEditor();break}case"disableEditor":{l&&l.disableEditor();break}case"loadGuides":{l&&l.loadGuides();break}case"getGuides":{if(l)return l.getGuides();break}default:console.warn("[Visual Designer] Unknown snippet method:",t)}}catch(n){console.error("[Visual Designer] Error processing queued call:",t,n)}})}if(typeof window<"u"){const s=window.visualDesigner;s&&Array.isArray(s._q)&&(v=!0);try{const e=new URL(window.location.href),t=e.searchParams.get("designer"),i=e.searchParams.get("mode");if(t==="true"){i&&(window.__visualDesignerMode=i,localStorage.setItem("designerModeType",i)),localStorage.setItem("designerMode","true"),e.searchParams.delete("designer"),e.searchParams.delete("mode");const n=e.toString();window.history.replaceState({},"",n),window.__visualDesignerWasLaunched=!0}}catch{}}if(typeof window<"u"&&!l){const s=window.__visualDesignerWasLaunched===!0;if(typeof localStorage<"u"&&localStorage.getItem("designerMode"),!v||s){const e=()=>{!l&&(!v||s)&&f()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}}typeof window<"u"&&(window.VisualDesigner={init:f,getInstance:E,DesignerSDK:b,_processQueue:w}),h.DesignerSDK=b,h._processQueue=w,h.getInstance=E,h.init=f,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})});
