(function(c,u){typeof exports=="object"&&typeof module<"u"?u(exports):typeof define=="function"&&define.amd?define(["exports"],u):(c=typeof globalThis<"u"?globalThis:c||self,u(c.VisualDesigner={}))})(this,function(c){"use strict";class u{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const r=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-testid"}}const t=this.getSemanticDataAttributes(e);if(t.length>0){const r=t[0],s=e.getAttribute(r);return{selector:`[${r}="${this.escapeAttribute(s)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const n=this.generatePathSelector(e);return n?{selector:n,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch(t){return console.error("Invalid selector:",e,t),null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const t=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const n of t)e.hasAttribute(n)&&i.push(n);for(let n=0;n<e.attributes.length;n++){const r=e.attributes[n];r.name.startsWith("data-")&&!i.includes(r.name)&&i.push(r.name)}return i}static generateAriaSelector(e){var r;const t=e.getAttribute("role"),i=e.getAttribute("aria-label"),n=e.getAttribute("aria-labelledby");if(t){let s=`[role="${this.escapeAttribute(t)}"]`;if(i)return s+=`[aria-label="${this.escapeAttribute(i)}"]`,s;if(n){const a=document.getElementById(n);if(a&&((r=a.textContent)==null?void 0:r.trim()))return s}return s}return null}static generatePathSelector(e){const t=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let n=i.tagName.toLowerCase();if(i.id){n+=`#${this.escapeSelector(i.id)}`,t.unshift(n);break}if(i.className&&typeof i.className=="string"){const s=i.className.split(/\s+/).filter(a=>a&&!a.startsWith("designer-")).slice(0,2);s.length>0&&(n+="."+s.map(a=>this.escapeSelector(a)).join("."))}const r=i.parentElement;if(r){const s=i.tagName,f=Array.from(r.children).filter(l=>l.tagName===s);if(f.length>1){const l=f.indexOf(i)+1;n+=`:nth-of-type(${l})`}}if(t.unshift(n),i=r,t.length>=5)break}return t.length>0?t.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function k(o){var i,n;const e=o.getBoundingClientRect(),t={};for(let r=0;r<o.attributes.length;r++){const s=o.attributes[r];t[s.name]=s.value}return{tagName:o.tagName.toLowerCase(),id:o.id||void 0,className:((i=o.className)==null?void 0:i.toString())||void 0,textContent:((n=o.textContent)==null?void 0:n.trim().substring(0,50))||void 0,attributes:t,boundingRect:e}}function y(o){const e=window.getComputedStyle(o);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&o.getBoundingClientRect().height>0&&o.getBoundingClientRect().width>0}function b(){return window.location.pathname||"/"}function I(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function B(o){const e=o.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function G(o){B(o)||o.scrollIntoView({behavior:"smooth",block:"center"})}class L{constructor(){this.isActive=!1,this.highlightOverlay=null,this.selectedElement=null,this.messageCallback=null,this.handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const t=e.target;if(!(!t||t===this.highlightOverlay)){if(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn")){this.hideHighlight();return}if(!y(t)){this.hideHighlight();return}this.highlightElement(t)}},this.handleClick=e=>{if(!this.isActive)return;const t=e.target;t&&(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn")||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),y(t)&&this.selectElement(t)))},this.handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback&&this.messageCallback({type:"CANCEL"}),this.selectedElement=null,this.hideHighlight())}}activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.selectedElement=null,this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
    ...
    `,r.onmouseover=()=>{r.style.background="#2563eb"},r.onmouseout=()=>{r.style.background="#3b82f6"},r.onclick=()=>{this.dismissGuide(e.id)},i.appendChild(r);const s=document.createElement("div");return s.className="designer-guide-arrow",s.style.cssText=`
      ...
      height: 0;
      border-style: solid;
    `,i.appendChild(s),i}positionTooltip(e,t,i){const n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),s=window.pageXOffset||document.documentElement.scrollLeft,a=window.pageYOffset||document.documentElement.scrollTop,f=e.querySelector(".designer-guide-arrow");let l=0,h=0,p="";switch(i){case"top":l=n.top+a-r.height-12,h=n.left+s+n.width/2-r.width/2,p=`
          bottom: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 8px 8px 0 8px;
          border-color: #3b82f6 transparent transparent transparent;
        `;break;case"bottom":l=n.bottom+a+12,h=n.left+s+n.width/2-r.width/2,p=`
          top: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 0 8px 8px 8px;
          border-color: transparent transparent #3b82f6 transparent;
        `;break;case"left":l=n.top+a+n.height/2-r.height/2,h=n.left+s-r.width-12,p=`
          right: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 0 8px 8px;
          border-color: transparent transparent transparent #3b82f6;
        `;break;case"right":l=n.top+a+n.height/2-r.height/2,h=n.right+s+12,p=`
          left: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 8px 8px 0;
          border-color: transparent #3b82f6 transparent transparent;
        `;break}const S=window.innerWidth,C=window.innerHeight;h<s?h=s+10:h+r.width>s+S&&(h=s+S-r.width-10),l<a?l=a+10:l+r.height>a+C&&(l=a+C-r.height-10),e.style.top=`${l}px`,e.style.left=`${h}px`,f&&(f.style.cssText+=p)}createContainer(){this.container=document.createElement("div"),this.container.id="designer-guides-container",this.container.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
