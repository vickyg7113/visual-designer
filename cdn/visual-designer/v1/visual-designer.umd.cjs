(function(u,p){typeof exports=="object"&&typeof module<"u"?p(exports):typeof define=="function"&&define.amd?define(["exports"],p):(u=typeof globalThis<"u"?globalThis:u||self,p(u.VisualDesigner={}))})(this,function(u){"use strict";class p{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const r=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-testid"}}const t=this.getSemanticDataAttributes(e);if(t.length>0){const r=t[0],o=e.getAttribute(r);return{selector:`[${r}="${this.escapeAttribute(o)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const n=this.generatePathSelector(e);return n?{selector:n,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch(t){return console.error("Invalid selector:",e,t),null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const t=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const n of t)e.hasAttribute(n)&&i.push(n);for(let n=0;n<e.attributes.length;n++){const r=e.attributes[n];r.name.startsWith("data-")&&!i.includes(r.name)&&i.push(r.name)}return i}static generateAriaSelector(e){var r;const t=e.getAttribute("role"),i=e.getAttribute("aria-label"),n=e.getAttribute("aria-labelledby");if(t){let o=`[role="${this.escapeAttribute(t)}"]`;if(i)return o+=`[aria-label="${this.escapeAttribute(i)}"]`,o;if(n){const s=document.getElementById(n);if(s&&((r=s.textContent)==null?void 0:r.trim()))return o}return o}return null}static generatePathSelector(e){const t=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let n=i.tagName.toLowerCase();if(i.id){n+=`#${this.escapeSelector(i.id)}`,t.unshift(n);break}if(i.className&&typeof i.className=="string"){const o=i.className.split(/\s+/).filter(s=>s&&!s.startsWith("designer-")).slice(0,2);o.length>0&&(n+="."+o.map(s=>this.escapeSelector(s)).join("."))}const r=i.parentElement;if(r){const o=i.tagName,c=Array.from(r.children).filter(l=>l.tagName===o);if(c.length>1){const l=c.indexOf(i)+1;n+=`:nth-of-type(${l})`}}if(t.unshift(n),i=r,t.length>=5)break}return t.length>0?t.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function T(a){var i,n;const e=a.getBoundingClientRect(),t={};for(let r=0;r<a.attributes.length;r++){const o=a.attributes[r];t[o.name]=o.value}return{tagName:a.tagName.toLowerCase(),id:a.id||void 0,className:((i=a.className)==null?void 0:i.toString())||void 0,textContent:((n=a.textContent)==null?void 0:n.trim().substring(0,50))||void 0,attributes:t,boundingRect:e}}function x(a){const e=window.getComputedStyle(a);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&a.getBoundingClientRect().height>0&&a.getBoundingClientRect().width>0}function m(){return window.location.pathname||"/"}function E(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function I(a){const e=a.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function L(a){I(a)||a.scrollIntoView({behavior:"smooth",block:"center"})}class M{constructor(){this.isActive=!1,this.highlightOverlay=null,this.selectedElement=null,this.messageCallback=null,this.handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const t=e.target;if(!(!t||t===this.highlightOverlay)){if(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")){this.hideHighlight();return}if(!x(t)){this.hideHighlight();return}this.highlightElement(t)}},this.handleClick=e=>{if(!this.isActive)return;const t=e.target;t&&(t.closest("#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge")||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),x(t)&&this.selectElement(t)))},this.handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback&&this.messageCallback({type:"CANCEL"}),this.selectedElement=null,this.hideHighlight())}}activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.selectedElement=null,this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
    ...
    `,document.head.appendChild(e)}removeEditorStyles(){const e=document.getElementById("designer-editor-styles");e&&e.remove()}}class D{constructor(){this.renderedGuides=new Map,this.container=null}renderGuides(e){this.clear();const t=m();e.filter(n=>n.page===t&&n.status==="active").forEach(n=>{this.renderGuide(n)})}renderGuide(e){const t=p.findElement(e.selector);if(!t){console.warn(`Guide "${e.id}" target not found: ${e.selector}`);return}L(t);const i=this.createTooltip(e,t);this.renderedGuides.set(e.id,i),this.container||this.createContainer(),this.container&&this.container.appendChild(i),this.positionTooltip(i,t,e.placement)}dismissGuide(e){const t=this.renderedGuides.get(e);t&&(t.remove(),this.renderedGuides.delete(e))}clear(){this.renderedGuides.forEach(e=>e.remove()),this.renderedGuides.clear()}createTooltip(e,t){const i=document.createElement("div");i.className="designer-guide-tooltip",i.dataset.guideId=e.id,i.style.cssText=`
      position: absolute;
      background: white;
      border: 2px solid #3b82f6;
      border-radius: 8px;
    ...
    `,r.onmouseover=()=>{r.style.background="#2563eb"},r.onmouseout=()=>{r.style.background="#3b82f6"},r.onclick=()=>{this.dismissGuide(e.id)},i.appendChild(r);const o=document.createElement("div");return o.className="designer-guide-arrow",o.style.cssText=`
      ...
      height: 0;
      border-style: solid;
    `,i.appendChild(o),i}positionTooltip(e,t,i){const n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),o=window.pageXOffset||document.documentElement.scrollLeft,s=window.pageYOffset||document.documentElement.scrollTop,c=e.querySelector(".designer-guide-arrow");let l=0,g=0,f="";switch(i){case"top":l=n.top+s-r.height-12,g=n.left+o+n.width/2-r.width/2,f=`
          bottom: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 8px 8px 0 8px;
          border-color: #3b82f6 transparent transparent transparent;
        `;break;case"bottom":l=n.bottom+s+12,g=n.left+o+n.width/2-r.width/2,f=`
          top: -8px;
          left: 50%;
          transform: translateX(-50%);
          border-width: 0 8px 8px 8px;
          border-color: transparent transparent #3b82f6 transparent;
        `;break;case"left":l=n.top+s+n.height/2-r.height/2,g=n.left+o-r.width-12,f=`
          right: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 0 8px 8px;
          border-color: transparent transparent transparent #3b82f6;
        `;break;case"right":l=n.top+s+n.height/2-r.height/2,g=n.right+o+12,f=`
          left: -8px;
          top: 50%;
          transform: translateY(-50%);
          border-width: 8px 8px 8px 0;
          border-color: transparent #3b82f6 transparent transparent;
        `;break}const C=window.innerWidth,B=window.innerHeight;g<o?g=o+10:g+r.width>o+C&&(g=o+C-r.width-10),l<s?l=s+10:l+r.height>s+B&&(l=s+B-r.height-10),e.style.top=`${l}px`,e.style.left=`${g}px`,c&&(c.style.cssText+=f)}createContainer(){this.container=document.createElement("div"),this.container.id="designer-guides-container",this.container.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
      ...
      pointer-events: none;
      z-index: 999996;
    `,document.body.appendChild(this.container)}updatePositions(e){this.renderedGuides.forEach((t,i)=>{const n=e.find(o=>o.id===i);if(!n)return;const r=p.findElement(n.selector);r&&this.positionTooltip(t,r,n.placement)})}}const w=["rgba(251, 191, 36, 0.35)","rgba(34, 197, 94, 0.35)","rgba(249, 115, 22, 0.35)"];class A{constructor(){this.overlays=new Map,this.container=null}render(e,t){if(this.clear(),!t||e.length===0)return;const i=this.getCurrentUrl(),n=this.normalizeUrl(i);e.filter(o=>o.url&&this.normalizeUrl(o.url)===n).forEach((o,s)=>{const c=p.findElement(o.selector);if(!c)return;const l=w[s%w.length],g=this.createOverlay(c,l,o.featureName);this.overlays.set(o.id,g),this.container||this.createContainer(),this.container&&this.container.appendChild(g)}),this.updatePositions(e)}updatePositions(e){this.overlays.forEach((t,i)=>{const n=e.find(l=>l.id===i);if(!n)return;const r=p.findElement(n.selector);if(!r)return;const o=r.getBoundingClientRect(),s=window.pageXOffset||document.documentElement.scrollLeft,c=window.pageYOffset||document.documentElement.scrollTop;t.style.left=`${o.left+s}px`,t.style.top=`${o.top+c}px`,t.style.width=`${o.width}px`,t.style.height=`${o.height}px`})}clear(){this.overlays.forEach(e=>e.remove()),this.overlays.clear()}destroy(){this.clear(),this.container&&(this.container.remove(),this.container=null)}createOverlay(e,t,i){const n=e.getBoundingClientRect(),r=window.pageXOffset||document.documentElement.scrollLeft,o=window.pageYOffset||document.documentElement.scrollTop,s=document.createElement("div");return s.className="designer-feature-heatmap-overlay",s.title=i,s.style.cssText=`
      position: absolute;
      left: ${n.left+r}px;
      top: ${n.top+o}px;
      width: ${n.width}px;
...
<body>
  ...
  <\/script>
    ...
    `,document.head.appendChild(t);const i=document.createElement("div");i.textContent="Loading Visual Designer...",i.style.cssText=`
      ...
      font-weight: 500;
      font-family: 'Montserrat', -apple-system, BlinkMacSystemFont, sans-serif;
    `,this.loadingOverlay.appendChild(e),this.loadingOverlay.appendChild(i),document.body.appendChild(this.loadingOverlay)}hideLoadingOverlay(){this.loadingOverlay&&(this.loadingOverlay.remove(),this.loadingOverlay=null)}}let d=null,k=!1;function h(a){return d||(d=new b(a),d.init(),d)}function v(){return d}function y(a){!a||!Array.isArray(a)||a.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const t=e[0],i=e.slice(1);try{switch(t){case"initialize":{const n=i[0];h(n);break}case"identify":{const n=i[0];n&&console.log("[Visual Designer] identify (snippet) called with:",n);break}case"enableEditor":{(d??h()).enableEditor();break}case"disableEditor":{d&&d.disableEditor();break}case"loadGuides":{d&&d.loadGuides();break}case"getGuides":{if(d)return d.getGuides();break}default:console.warn("[Visual Designer] Unknown snippet method:",t)}}catch(n){console.error("[Visual Designer] Error processing queued call:",t,n)}})}if(typeof window<"u"){const a=window.visualDesigner;a&&Array.isArray(a._q)&&(k=!0,a.initialize=e=>{h(e)},a.identify=e=>{e&&console.log("[Visual Designer] identify (snippet) called with:",e)},a.enableEditor=()=>{(d??h()).enableEditor()},a.disableEditor=()=>{d&&d.disableEditor()},a.loadGuides=()=>{d&&d.loadGuides()},a.getGuides=()=>d?d.getGuides():void 0,a.getInstance=v,a.init=h,y(a._q));try{const e=new URL(window.location.href),t=e.searchParams.get("designer"),i=e.searchParams.get("mode");if(t==="true"){i&&(window.__visualDesignerMode=i,localStorage.setItem("designerModeType",i)),localStorage.setItem("designerMode","true"),e.searchParams.delete("designer"),e.searchParams.delete("mode");const n=e.toString();window.history.replaceState({},"",n),window.__visualDesignerWasLaunched=!0}}catch{}}if(typeof window<"u"&&!d&&!k){const a=()=>{d||h()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a()}typeof window<"u"&&(window.VisualDesigner={init:h,initialize:h,getInstance:v,DesignerSDK:b,_processQueue:y}),u.DesignerSDK=b,u._processQueue=y,u.getInstance=v,u.init=h,Object.defineProperty(u,Symbol.toStringTag,{value:"Module"})});
